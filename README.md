There are 2 folders that contain the public data with the T2-weighted MRIs and their corresponding labels. You need to download them from here: https://pi-cai.grand-challenge.org/DATA/
